...
INSERT INTO `destination` (`dest_id`, `dest_destination`) VALUES(1, 'Chandigarh');
INSERT INTO `destination` (`dest_id`, `dest_destination`) VALUES(2, 'Amritsar');
INSERT INTO `destination` (`dest_id`, `dest_destination`) VALUES(3, 'New Delhi');
INSERT INTO `destination` (`dest_id`, `dest_destination`) VALUES(4, 'Jalandhar');
INSERT INTO `destination` (`dest_id`, `dest_destination`) VALUES(5, 'Ludhiana');
INSERT INTO `destination` (`dest_id`, `dest_destination`) VALUES(6, 'Shimla');
...
INSERT INTO `origin` (`origin_id`, `origin_desc`) VALUES(1, 'Chandigarh');
INSERT INTO `origin` (`origin_id`, `origin_desc`) VALUES(2, 'Amritsar');
INSERT INTO `origin` (`origin_id`, `origin_desc`) VALUES(3, 'New Delhi');
INSERT INTO `origin` (`origin_id`, `origin_desc`) VALUES(4, 'Jalandhar');
INSERT INTO `origin` (`origin_id`, `origin_desc`) VALUES(5, 'Ludhiana');
INSERT INTO `origin` (`origin_id`, `origin_desc`) VALUES(6, 'Shimla');
